      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <div className="rounded-2xl shadow-lg overflow-hidden bg-blue-50 hover:scale-105 transition-transform">
            <Image src="/1.png" alt="Kathmandu" width={400} height={200} className="w-full h-48 object-cover" sizes="(max-width: 600px) 100vw, 400px" quality={60} />
            <div className="p-4">
          ...
          <div className="rounded-2xl shadow-lg overflow-hidden bg-blue-50 hover:scale-105 transition-transform">
            <Image src="/2.png" alt="Pokhara" width={400} height={200} className="w-full h-48 object-cover" sizes="(max-width: 600px) 100vw, 400px" quality={60} />
            <div className="p-4">
          ...
          <div className="rounded-2xl shadow-lg overflow-hidden bg-blue-50 hover:scale-105 transition-transform">
            <Image src="/3.png" alt="Chitwan" width={400} height={200} className="w-full h-48 object-cover" sizes="(max-width: 600px) 100vw, 400px" quality={60} />
            <div className="p-4">
